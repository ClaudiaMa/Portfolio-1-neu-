...
public class UserBean {
     ...
     */
    public void signup(String username, String password, String name, String strasse, String plz, String ort, String email, String telefon) throws UserAlreadyExistsException {
        if (em.find(User.class, username) != null) {
            throw new UserAlreadyExistsException("Der Benutzername $B ist bereits vergeben.".replace("$B", username));
        }

        User user = new User(username, password, name, strasse, plz, ort, email, telefon);
        user.addToGroup("middlemarkt-app-user");
        em.persist(user);
    }
     ...
     */
    @RolesAllowed("middlemarkt-app-user")
