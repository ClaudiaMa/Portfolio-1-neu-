...
public class Task implements Serializable {
  ...
  //  private String anbieter;
    ...
    @Enumerated(EnumType.STRING)
    private Price pstatus = Price.VERHANDLUNGSBASIS;
    
    //<editor-fold defaultstate="collapsed" desc="Konstruktoren">
    public Task() {
    }

    public Task(User owner, Category category, TaskStatus status, String shortText, Date dueDate, Time dueTime, String longText, String preis, Price pstatus){
        this.owner = owner;
    ...
    **/
    ...
    public Price getPStatus() {
        return pstatus;
    }
    
    public void setPStatus(Price pstatus){
        this.pstatus = pstatus;
    }
    //</editor-fold>
